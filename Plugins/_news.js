let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `𝑫𝑬𝑴𝑶𝑵𝑰𝑪 *𝑪𝑱* 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 𝙎𝙐𝙋𝙋𝙊𝙍𝙏\n\n _ʜᴇʏ ʜᴇʀᴇ's ᴏᴜʀ ᴄʜᴀɴɴᴇʟ ʟɪɴᴋ, ᴘʟᴇᴀsᴇ ғᴏʟʟᴏᴡ ᴀɴᴅ sᴜᴘᴘᴏʀᴛ ᴜs ᴛᴏ ᴋᴇᴇᴘ ᴛʜɪs ᴘʀᴏᴊᴇᴄᴛ ᴀʟɪᴠᴇ_\n *ʟɪɴᴋ:* https://whatsapp.com/channel/0029VajOKquG3R3pOUajb71j\n\n ${Config.botname} *© CJ*`;
...
smd(
 ...
 smd({
   ...
   try {
     let _0x12a593 = "*DEMONIC-CJ-V3 CURRENTLY ACTIVE!*";
