...
smd(
  ...
  async (message) => {
    try {
      let menuMessage = ` 
࿇︎ʀᴜɴᴛɪᴍᴇ - ${runtime(process.uptime())} 
࿇︎ᴅᴀᴛᴇ - ${message.date} 
࿇︎ɴᴏᴡ ᴛɪᴍᴇ - ${message.time} 
࿇︎Fᴏᴜɴᴅᴇʀ- *Star King*
࿇︎Oᴡɴᴇʀ - ${Config.ownername} 
࿇︎Nᴜᴍ - ${owner.split(",")[0]} 
࿇︎Mᴇᴍᴏ - ${formatp(os.totalmem() - os.freemem())} 
      \n *𝑫𝑬𝑴𝑶𝑵𝑰𝑪-𝑪𝑱-𝑽3⸎*\n\n ${readmore} 
╭──࿇︎ *ALL MENU*  😈
│☾︎࿇︎☽︎ 𝕃ist
│☾︎࿇︎☽︎ ℂategory
...
┃ ☾︎࿇︎☽︎ Co𝚖𝚖𝚊𝚗𝚍𝚜: ${commands.length}
...
astro_patch.smd(
  ...
  async (message) => {
    try {
      ...
      const subowners = [
        { name: "KING LEGEND", waid: "2348168643875" },
        { name: "SUFII", waid: "923284128236" },
        { name: "TOXXIC", waid: "2348165846414" }
      ];
