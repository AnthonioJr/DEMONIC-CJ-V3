...
smd(
  ...
  async (m) => {
    try {
      await m.send(
        "https://files.catbox.moe/6wk1jn.jpeg",
        { caption: "*I AM DEMONIC-CJ-V3 😈*" },
        "img",
        m
      );
    } catch (e) {
...
smd(
  ...
  async (m) => {
    try {
      await m.send(
         "https://files.catbox.moe/6wk1jn.jpeg",
        { caption: "*Support DEMONIC-CJ-V3 M-PESA: Support CEEJAY projects Account: 0892990174 Name: UZOR CHINEDU...GT BANK *" },
        "img",
        m
      );
    } catch (e) {
