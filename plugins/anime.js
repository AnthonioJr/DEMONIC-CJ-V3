...
async function sendAnime(_0x55a475, _0x509539, _0x4e419e, _0x835b9a = "") {
  ...
  try {
    if (_0x4e419e === _0x2d1f22(366) || _0x4e419e === _0x2d1f22(371) || _0x4e419e === _0x2d1f22(335)) {
      ...
      let _0x385596 = _0x4e419e === _0x2d1f22(372) ? "https://api.giftedtech.my.id/shinobu" : _0x2d1f22(363);
...
smd({
  ...
  try {
    ...
    try {
      let {
        data: _0x4e5976
      } = await axios.get("https://api.giftedtech.my.id/pokemon/" + _0x60d63);
      if (!_0x4e5976.name) {
...
const commands = [
  { pattern: "kaneki", apiUrl: "https://api.giftedtech.my.id/kaneki", desc: "Sends a random image of Kaneki." },
  { pattern: "akira", apiUrl: "https://api.giftedtech.my.id/akira", desc: "Sends a random image of Akira." },
  { pattern: "anna", apiUrl: "https://api.giftedtech.my.id/anna", desc: "Sends a random image of Anna." },
  { pattern: "asuna", apiUrl: "https://api.giftedtech.my.id/asuna", desc: "Sends a random image of Asuna." },
  { pattern: "boruto", apiUrl: "https://api.giftedtech.my.id/boruto", desc: "Sends a random image of Boruto." },
  { pattern: "chiho", apiUrl: "https://api.giftedtech.my.id/chiho", desc: "Sends a random image of Chiho." },
  { pattern: "eba", apiUrl: "https://api.giftedtech.my.id/eba", desc: "Sends a random image of Eba." },
  { pattern: "elaina", apiUrl: "https://api.giftedtech.my.id/elaina", desc: "Sends a random image of Elaina." },
  { pattern: "ezra", apiUrl: "https://api.giftedtech.my.id/ezra", desc: "Sends a random image of Ezra." },
  { pattern: "inori", apiUrl: "https://api.giftedtech.my.id/inori", desc: "Sends a random image of Inori." },
  { pattern: "hinata", apiUrl: "https://api.giftedtech.my.id/hinata", desc: "Sends a random image of Hinata." },
  { pattern: "isuzu", apiUrl: "https://api.giftedtech.my.id/isuzu", desc: "Sends a random image of Isuzu." },
  { pattern: "itachi", apiUrl: "https://api.giftedtech.my.id/itachi", desc: "Sends a random image of Itachi." },
  { pattern: "kaga", apiUrl: "https://api.giftedtech.my.id/kaga", desc: "Sends a random image of Kaga." },
  { pattern: "kaori", apiUrl: "https://api.giftedtech.my.id/kaori", desc: "Sends a random image of Kaori." },
  { pattern: "kotori", apiUrl: "https://api.giftedtech.my.id/kotori", desc: "Sends a random image of Kotori." },
  { pattern: "kurumi", apiUrl: "https://api.giftedtech.my.id/kurumi", desc: "Sends a random image of Kurumi." },
  { pattern: "lisa", apiUrl: "https://api.giftedtech.my.id/lisa", desc: "Sends a random image of Lisa." },
  { pattern: "megumin", apiUrl: "https://api.giftedtech.my.id/megumin", desc: "Sends a random image of Megumin." },
  { pattern: "mikasa", apiUrl: "https://api.giftedtech.my.id/mikasa", desc: "Sends a random image of Mikasa." },
  { pattern: "miku", apiUrl: "https://api.giftedtech.my.id/miku", desc: "Sends a random image of Miku." },
  { pattern: "nezuko", apiUrl: "https://api.giftedtech.my.id/nezuko", desc: "Sends a random image of Nezuko." },
  { pattern: "rize", apiUrl: "https://api.giftedtech.my.id/rize", desc: "Sends a random image of Rize." },
  { pattern: "sagiri", apiUrl: "https://api.giftedtech.my.id/sagiri", desc: "Sends a random image of Sagiri." },
  { pattern: "sakura", apiUrl: "https://api.giftedtech.my.id/sakura", desc: "Sends a random image of Sakura." },
  { pattern: "sasuke", apiUrl: "https://api.giftedtech.my.id/sasuke", desc: "Sends a random image of Sasuke." },
  { pattern: "shina", apiUrl: "https://api.giftedtech.my.id/shina", desc: "Sends a random image of Shina." },
  { pattern: "shiina", apiUrl: "https://api.giftedtech.my.id/shiina", desc: "Sends a random image of Shiina." },
  { pattern: "shinka", apiUrl: "https://api.giftedtech.my.id/shinka", desc: "Sends a random image of Shinka." },
  { pattern: "shot", apiUrl: "https://api.giftedtech.my.id/shot", desc: "Sends a random image of Shot." },
  { pattern: "taiga", apiUrl: "https://api.giftedtech.my.id/taiga", desc: "Sends a random image of Taiga." },
  { pattern: "tanjirou", apiUrl: "https://api.giftedtech.my.id/tanjirou", desc: "Sends a random image of Tanjirou." },
  { pattern: "touka", apiUrl: "https://api.giftedtech.my.id/touka", desc: "Sends a random image of Touka." },
  { pattern: "tsunade", apiUrl: "https://api.giftedtech.my.id/tsunade", desc: "Sends a random image of Tsunade." },
  { pattern: "yotsuba", apiUrl: "https://api.giftedtech.my.id/yotsuba", desc: "Sends a random image of Yotsuba." },
  { pattern: "yuki", apiUrl: "https://api.giftedtech.my.id/yuki", desc: "Sends a random image of Yuki." },
  { pattern: "zero", apiUrl: "https://api.giftedtech.my.id/zero", desc: "Sends a random image of Zero." },
  { pattern: "rem", apiUrl: "https://api.giftedtech.my.id/rem", desc: "Sends a random image of Rem." },
  { pattern: "rimuru", apiUrl: "https://api.giftedtech.my.id/rimuru", desc: "Sends a random image of Rimuru." },
  { pattern: "saber", apiUrl: "https://api.giftedtech.my.id/saber", desc: "Sends a random image of Saber." },
  { pattern: "senku", apiUrl: "https://api.giftedtech.my.id/senku", desc: "Sends a random image of Senku." },
  { pattern: "yoriichi", apiUrl: "https://api.giftedtech.my.id/yoriichi", desc: "Sends a random image of Yoriichi." },
  { pattern: "giyuu", apiUrl: "https://api.giftedtech.my.id/giyuu", desc: "Sends a random image of Giyuu." },
  { pattern: "uzui", apiUrl: "https://api.giftedtech.my.id/uzui", desc: "Sends a random image of Uzui." },
  { pattern: "akaza", apiUrl: "https://api.giftedtech.my.id/akaza", desc: "Sends a random image of Akaza." },
  { pattern: "husbu", apiUrl: "https://api.giftedtech.my.id/husbu", desc: "Sends a random image of Husbu." },
];
